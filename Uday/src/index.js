...
// const token = require("./config.json"); // BOT Token from config.json file.
...
client.once("ready", () => {
	...
	console.log(`Reloaded Commands! - Logged in as ${client.user.tag}!`);
});
...
// Login to the bot client via the defined "token" string.
client.login(token);
